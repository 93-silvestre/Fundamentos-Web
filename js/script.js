// var - escopo global
// let - escopo local
// const - escopo global , não muda valor 
...
por id = geteElementsById()
por nome = getElementsByName()
por classe = geteElementsClassName()
por seletor = querySelector() - ultima atualização , melhor pratica para utilizar
*/



/*let nome = window.document.getElementsById("nome") // acessando input que tem elemento nome
...
function validaNome(){ // validando campo nome
      
    if (nome.value.length < 3){ // se for digitado menos de 3 letras , nome invalido
        alert('nome inválido')
    }
}
*/
